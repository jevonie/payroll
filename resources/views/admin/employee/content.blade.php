        ...
        <table id="employee_data_table" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
             <td>
              @php
                 $mediaItems = $employee->getMediaUrlAttribute()['original']; 
              @endphp
               <img src="{{$employee->mediaUrl['thumb']}}" item="{{$mediaItems}}" class='table-user-thumb'>
             </td>
             ...
             <td>
               <div class=''>
                ...
                <b>Employee Id : <span>{{$employee->id}}</span></b></br>
