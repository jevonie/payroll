            ...
            <tr>
              ...
              <td>
                <div class="row">
                  <div class="col-md-3 text-center">
                    <img src="{{ $advance->employee->mediaUrl['thumb'] }}" class="rounded-circle table-user-thumb">
                  </div>
              ...
              <td>
                <div class='table-actions text-center'>
                  <a href="{{route("admin.cashadvance.edit",$advance->slug)}}"><i class='ik ik-edit-2 text-dark'></i></a>
                  <a data-href="{{route("admin.cashadvance.destroy",$advance->slug)}}" class='delete cursure-pointer'><i class='ik ik-trash-2 text-danger'></i></a>
                </div>
              </td>
              <td>
