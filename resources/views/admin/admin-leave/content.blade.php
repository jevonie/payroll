              ...
              <tr>
               ...
               <td>
                 ...
                 <div class='table-actions'>
                  <a data-href="{{route('admin.admin-leave.show',$leave->id)}}" class='show-employee cursure-pointer'>
                    <i class='ik ik-eye text-primary'></i>
                  </a>
                  @if (auth()->user()->role == 'admin')
                    @if ($leave->status == "PENDING")
                      <a href="{{route("admin.admin-leave.edit",$leave)}}">
                        <i class='ik ik-edit-2 text-dark'></i>
                      </a>
                      <a data-href="{{route("admin.admin-leave.destroy",$leave)}}" class='delete cursure-pointer'><i class='ik ik-trash-2 text-danger'></i></a>
                    @endif
                  @endif
                </div>
