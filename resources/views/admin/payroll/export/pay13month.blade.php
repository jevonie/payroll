...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>13TH MONTH PAY {{ $date }} | AMS - A System for HR Payment Generator. </title>
    <style type="text/css">
      body {
          position: relative;
          width: auto;  
  ...
  <body>
    <div class="card border-1">
          <div class="card-header">
              <h2 class="text-center border-top-bootom-1 py-4">AMS - EMPLOYEE 13TH MONTH PAYMENT</h2>
                  ...
                  <div class="col-12 table-responsive">
                    <table cellspacing="0" cellpadding="3" class="table">  
                        ...
                        <tr> 
                            <td></td> 
                            <td></td>
                            <td width="25%" align="right"><b>13th month Pay:</b></td>
                            <td width="25%" align="right"><b>
                                {{ number_format($payroll->gross_amount / 12,2) }}
                            </b></td> 
                        </tr>
                    </table><hr>
                  </div>
