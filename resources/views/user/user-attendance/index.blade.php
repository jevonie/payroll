  ...
  <div class="row align-items-end">
    <div class="col-lg-8">
      <div class="page-header-title">
        <i class="fa fa-calendar bg-blue" aria-hidden="true"></i>
        <div class="d-inline">
          <h5>My Attendances</h5>
          <span>You can show Attendances from here.</span>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <nav class="breadcrumb-container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{ route('admin.attendance.index') }}">Attendances</a>
          </li>
          <li class="breadcrumb-item active" aria-current="page">My Attendances</li>
        </ol>
      </nav>
    </div>
  </div>
