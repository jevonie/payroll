                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
                                        ...
                                        <span class="badge bg-primary badge-number">{{ $user_counts['leaves_count'] }}</span>
                                    </div>
                                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-arrow notifications">
                                        <li class="dropdown-header">
                                          You have {{ $user_counts['leaves_count'] }} new notifications
                                        </li>
                                        <li>
                                          <hr class="dropdown-divider">
                                        </li>
                                        @foreach ($user_counts['leaves'] as $item)
                                        <li class="notification-item">
                                            <i class="bi bi-exclamation-circle text-warning"></i>
                                            <a href="{{ route("user.leave.notifUpdate", $item->id)}}">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="{{ route('user.profile.index') }}"><i class="ik ik-user dropdown-icon"></i> Profile</a>
            ...
            <div class="page-wrap">
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="{{ url('/') }}">
                            <div class="logo-img">
                               <img src="{{ asset('./admin_assets/new_logo.png') }}" width="32">
                            </div>
                            <small class="text pl-2"><b>AMS</b></small>
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">AMS@2023</span>
